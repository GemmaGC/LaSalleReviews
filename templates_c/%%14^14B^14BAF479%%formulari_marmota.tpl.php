<?php /* Smarty version 2.6.14, created on 2014-03-13 11:25:24
         compiled from exercici3/formulari_marmota.tpl */ ?>
    ...
    <form name="insert-form" class="insert-form" action="" method="post">
        ...
        <div class="header_afegeix">
            <h1 class="bbdd">AFEGIR MARMOTA A LA BASE DE DADES</h1>
        ...
        <div class="footer-form">
            <input type="submit" name="submit_marmota" value="Enviar" class="button" />
